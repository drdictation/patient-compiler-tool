...
Your task is to produce an **Initial Consultation Letter** for a patient with **Inflammatory Bowel Disease (IBD)**.
...
# Output Structure
**Summary**
- **[IBD diagnosis, phenotype, and activity]**
- **[Current IBD therapy and key management decision]**
...
[Include stool frequency, bleeding, pain, systemic features, flares, and timeline.]

**Diet**
[Dietary intake and restrictions relevant to IBD.]

**Past medical history and medications**
[Concise narrative or list, including current and prior IBD therapies.]

**Social history, family history**
[Employment, living situation, family IBD history.]

**Examination**
[Physical findings. If none: "I did not perform a physical examination."]

**Impression and plan**
[Explain disease assessment, rationale for therapy, monitoring, investigations, and follow-up.]
