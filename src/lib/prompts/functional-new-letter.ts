...
- No other interventions made today and no action is required by you.
...
I also think the fact that she has an overactive bladder requiring Botox and sense of incomplete emptying. She has a defecatory disorder and likely has a poorly relaxing pelvic floor I think she greatly benefit for seeing a pelvic floor physiotherapist

She has typical reflux symptoms which respond to a PPI but she has atypical esophageal symptoms which may in fact be consistent with retrograde cricopharyngeal dysfunction. This is a newly recognised disorder where patients who usually have a lifetime of an inability to burp, have a sensation of gas feeling trapped in their chest, usually accompanied by bloating, bloating and occasionally accompanied by excessive flatulence. The treatment involves usually a Botox to the upper esophageal sphincter. It's also noteworthy though that when she does manoeuvre to release gas from her esophagus, it doesn't relieve her symptoms entirely. So I suspect multiple factors are at play.

We had a very lengthy discussion about how we might approach this. Ultimately, given her limited and poor success with neuromodulators, I'm slightly pessimistic about the prospect that they're going to be very effective here. But I wonder if we should try a dose up to 150 milligrams to see if this has an effect. This, of course, may be complicated by weight gain, which is an entirely new issue that she's trying to deal with. I support your prescription of the semaglutide. I have several patients in a similar situation where they've found general improvements in bodily related systems. And I wonder whether or not that might be the case here. Instead for now, I've asked her to start nortriptyline to escalate to 75 milligrams before our appointment in eight weeks time. If she develops weight gain or in fact now I'd be supportive of her starting semaglutide

I've asked to see one of our pelvic floor physiotherapists to deal with not only the urinary but the bowel dysfunction.
...
The third issue is abnormal bowel movements. Typically show up as the bowels three times a day, but it can be up to six times a day. It can be complicated by faecal incontinence. Typically pale or loose stools can be oily and difficult to flush. She's concerned about steatorrhoea. She's had a previous faecal elastase which is normal. She denies the passage of blood or mucus. She doesn't spend excessive amounts of time on the toilet and usually has a sense of complete emptying at the time of evacuating her stools. No issues to do with urination  some discomfort during intercourse relating to lichen sclerosus.
...
Her abdominal distention, which has been previously labelled as SIBO, probably requires cross-sectional imaging as it's been progressively getting worse over the years. I will organise for her to have a CT scan.

Given her steatorrhoea-like symptoms, it's worth doing a faecal elastase. There may be some benefit in doing supplements for this anyway, irrespective. I wonder though, given she has potential pancreatic exocrine insufficiency and recurrent pneumonias, I guess the prospect of cystic fibrosis can be raised. although her cough is not productive and presumably Piers would have been able to include or exclude that possibility at his last assessment (Piers Canty) being her respiratory physician.

I've given her general lifestyle advice regarding most of her symptoms.

Given her frequent loose stools which can be complicated by faecal incontinence, I do think she'd benefit from seeing a bowel-specific pelvic floor physiotherapist. Mental health is also a factor here. She's going to see a psychiatrist. If she has any difficulty with that, I'd recommend her seeing a psychiatrist within our practice.

I will update you after the tests. Thank you again for this referral
